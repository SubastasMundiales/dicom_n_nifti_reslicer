...
Read the sagital dicom scan and create the coronal and axial slices
11/2022
by: Aranca2504
"""
...
fpath = '/Users/macbook/Desktop/dcm_scan_loader/sagital'
# load the DICOM files
files_id = next(os.walk(fpath))[2]
print(files_id)
files = []
path_file = 'sagital/' + files_id[0]
for fname in files_id:
    r,extension = os.path.splitext(fname)
    if extension == '.dcm':
        print("loading: {}".format(fname))
        files.append(pydicom.dcmread('sagital/' + fname))
